...
| `service_updates.py` | Gate, validità, priorità e rotazione degli avvisi operativi |
| `service_facebook.py` | Post e primo commento dedicati agli aggiornamenti utili |
